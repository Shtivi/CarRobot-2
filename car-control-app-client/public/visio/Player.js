...
(function (root, factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(["./libs/visio/Decoder", "./libs/visio/YUVCanvas"], factory);
    } else if (typeof exports === 'object') {
        // Node. Does not work with strict CommonJS, but
        // only CommonJS-like environments that support module.exports,
        // like Node.
        module.exports = factory(require("./libs/visio/Decoder"), require("./libs/visio/YUVCanvas"));
    } else {
  ...
  var Player = function(parOptions){
    ...
    this._config.workerFile = this._config.workerFile || "./libs/visio/Decoder.js";
  ...
  Player.prototype = {
    ...
    _createBasicCanvasObj: function(options){
      ...
      // obj.canvas.style.backgroundColor = "#eee";
      // obj.canvas.style.background = "url('/images/live-stream.png') no-repeat center"
